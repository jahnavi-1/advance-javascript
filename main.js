...
function errorHandling() {
  ...
  .get('https://jsonplaceholder.typicode.com/todoss',{
    validateStatus:function(status){
      return status<500;//rejectonly if status greater or equal to 500
    }
  })
  .then(res=>showOutput(res))
  .catch(err=>{
...
// if you to soemthing when you make a request form fe to be
//axios.post(url,{})
//contenttype:applocation/JSON
//headers which need to be sent every time 